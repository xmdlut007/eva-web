...
public class SimpleMailSender {
    ...
    public static void main(String args[]) {
        ...
        mailInfo.setUserName("qiuwenming1988@163.com");// (mail_address.split("@")[0]);
                                                 // // "863406563"
        mailInfo.setPassword("801310");// 您的邮箱密码
        mailInfo.setFromAddress("qiuwenming1988@163.com"); // 发送人
        mailInfo.setToAddress("qiuwenming19881020@126.com"); // 接收人
        mailInfo.setSubject("用户邮箱验证!");
        mailInfo.setContent("xxxx");
